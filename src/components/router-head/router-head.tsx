...
export const RouterHead = component$(() => {
  ...
  return (
    <>
      ...
      <meta
        name="description"
        content="Inclure.net: Site d'IA pour rendre les textes inclusifs"
      />
      ...
      <meta
        property="og:image"
        content="https://gwytigvyfawwmshpjsas.supabase.co/storage/v1/object/public/img-bucket/inclure.webp"
      />
